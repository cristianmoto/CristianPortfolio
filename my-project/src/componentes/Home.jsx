...
export const Home = () => {
  return (
   <section className=" container mx-auto my-40 text-center cursor-pointer">
    <p className="text-3xl text-stone-100 text-opacity-40 italic  pt-10 hover:text-pink-500 " >Hola , Soy!</p>
  <span className="text-7xl text-stone-100 font-mono hover:text-pink-800">Cristian Aguirre</span>
    <p className="text-3xl text-stone-100 text-opacity-40 italic pb-10  hover:text-pink-500" >Desarrollador FrontEnd</p>
    ...
    <p className="text-2xl text-stone-100 text-opacity-40 italic pb-10  hover:text-pink-500 ">apasionado por la programacion</p> 
    <hr></hr>
